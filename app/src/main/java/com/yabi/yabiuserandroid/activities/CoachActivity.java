...
public class CoachActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!sharedPrefUtils.isFirstTimeLaunch()) {
            launchHomeScreen();
            finish();
        }
        ...
        layouts = new int[]{
                R.layout.coach_screen1,
                R.layout.coach_screen2,
                R.layout.coach_screen3,
                R.layout.coach_screen4};
...
//        startActivity(new Intent(CoachActivity.this, LoginActivity.class));
        startActivity(new Intent(CoachActivity.this, FbLoginActivity.class));
        finish();
    }
    ...
    private void changeStatusBarColor() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            window.setStatusBarColor(getResources().getColor(R.color.dot_dark_screen1));
        }
    }
